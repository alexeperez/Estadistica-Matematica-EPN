...
\end{equation*}
Suponiendo que $u_i \rightsquigarrow N(0, \sigma^2)$, encuentre MLEs para $\beta_1, \dots, \beta_k$ basados en
$Y_1,\dots, Y_n$, considerando los regresores $X_2,\dots,X_k$ no aleatorios.
